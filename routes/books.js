...
// @access  Public
router.get('/featured', featuredBooksCache, asyncHandler(async (req, res, next) => {
...
// @access  Public
router.get('/bestsellers', bestsellersCache, asyncHandler(async (req, res, next) => {
...
// @access  Public
router.get('/new-releases', newReleasesCache, asyncHandler(async (req, res, next) => {
...
router.post('/', protect, adminOnly, bookCacheInvalidation, [
